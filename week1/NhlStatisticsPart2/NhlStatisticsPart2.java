    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                System.out.println("Which player's statistics are you looking for? ");
                String playersearch = reader.nextLine();
                NHLStatistics.searchByPlayer(playersearch);
                ...
                System.out.println("Which club's statistics are you looking for? ");
                String teamsearch = reader.nextLine();
                NHLStatistics.sortByPoints();
                NHLStatistics.teamStatistics(teamsearch);
            }
